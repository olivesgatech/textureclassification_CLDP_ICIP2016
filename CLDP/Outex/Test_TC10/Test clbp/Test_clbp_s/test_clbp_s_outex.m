%% riu2 CLBP_S with NNC

function [accuracyCLBP, elapsedtime]=test_clbp_s_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = clbp_s(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = clbp_s(img,r,p,mapping,'h');
