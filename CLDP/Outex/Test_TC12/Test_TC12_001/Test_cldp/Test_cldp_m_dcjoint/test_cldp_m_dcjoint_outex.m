...
function[accuracyCLBP, elapsedtime] = test_cldp_m_dcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    [CLBP_M, CLBP_DCjoint]= cldp_m_dcjoint(img,r,p,mapping,'h');
    clbp_trains(i,:)=[CLBP_M, CLBP_DCjoint];
...
for i = 1:test_num
    ...
    [CLBP_M, CLBP_DCjoint]= cldp_m_dcjoint(img,r,p,mapping,'h');
    clbp_tests(i,:)=[CLBP_M, CLBP_DCjoint];
