...
function[accuracyCLBP, elapsedtime] = test_cldp_mdcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = cldp_mdcjoint(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = cldp_mdcjoint(img,r,p,mapping,'h');
