%% riu2 CLBP_M/C with NNC

function [accuracyCLBP, elapsedtime]=test_clbp_mcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = clbp_mcjoint(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = clbp_mcjoint(img,r,p,mapping,'h');
