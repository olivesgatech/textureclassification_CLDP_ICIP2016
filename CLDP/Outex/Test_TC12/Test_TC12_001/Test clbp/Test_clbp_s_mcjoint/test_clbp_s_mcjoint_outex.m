%% riu2 CLBP_S_M/C with NNC

function [accuracyCLBP, elapsedtime]=test_clbp_s_mcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    [CLBP_S CLBP_MCjoint] = clbp_s_mcjoint(img,r,p,mapping,'h');
    clbp_trains(i,:) = [CLBP_S CLBP_MCjoint];
...
for i = 1:test_num
    ...
    [CLBP_S CLBP_MCjoint] = clbp_s_mcjoint(img,r,p,mapping,'h');
    clbp_tests(i,:) = [CLBP_S CLBP_MCjoint];
