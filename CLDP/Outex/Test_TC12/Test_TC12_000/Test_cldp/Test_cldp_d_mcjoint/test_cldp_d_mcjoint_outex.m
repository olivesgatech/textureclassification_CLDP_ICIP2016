...
function[accuracyCLBP, elapsedtime] = test_cldp_d_mcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    [CLBP_D, CLBP_MCjoint]= cldp_d_mcjoint(img,r,p,mapping,'h');
    clbp_trains(i,:)=[CLBP_D, CLBP_MCjoint];
...
for i = 1:test_num
    ...
    [CLBP_D, CLBP_MCjoint]= cldp_d_mcjoint(img,r,p,mapping,'h');
    clbp_tests(i,:)=[CLBP_D, CLBP_MCjoint];
