%% riu2 CLBP_S/D with NNC
function[accuracyCLBP, elapsedtime] = test_cldp_mdjoint_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = cldp_mdjoint(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = cldp_mdjoint(img,r,p,mapping,'h');
