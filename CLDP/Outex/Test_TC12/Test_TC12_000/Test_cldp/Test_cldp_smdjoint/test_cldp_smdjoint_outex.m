...
function[accuracyCLBP, elapsedtime] = test_cldp_smdjoint_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = cldp_smdjoint(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = cldp_smdjoint(img,r,p,mapping,'h');
