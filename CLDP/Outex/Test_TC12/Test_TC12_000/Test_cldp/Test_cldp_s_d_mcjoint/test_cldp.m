...
% Outex TC12:000
addpath('C:\Users\yhu75\Dropbox (GhassanGT)\Yuting\Big_and_Data\Research\Trial\Texture representation\Database\Outex\TC12\Outex_TC_00012.tar\Outex_TC_00012\Outex_TC_00012\000');
...
% for r=2
%     for p=8
        [accuracyCLBP(p/8,r), elapsedtime(p/8,r)]=test_cldp_s_d_mcjoint_outex(p,r);
    end
end
save