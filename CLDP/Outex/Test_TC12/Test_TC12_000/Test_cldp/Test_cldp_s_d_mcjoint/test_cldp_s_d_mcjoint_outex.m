%% riu2 CLBP_S_D_M/C with NNC
function[accuracyCLBP, elapsedtime] = test_cldp_s_d_mcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    [CLBP_S, CLBP_D, CLBP_MCjoint]= cldp_s_d_mcjoint(img,r,p,mapping,'h');
    clbp_trains(i,:)=[CLBP_S, CLBP_D, CLBP_MCjoint];
...
for i = 1:test_num
    ...
    [CLBP_S, CLBP_D, CLBP_MCjoint]= cldp_s_d_mcjoint(img,r,p,mapping,'h');
    clbp_tests(i,:)=[CLBP_S, CLBP_D, CLBP_MCjoint];
