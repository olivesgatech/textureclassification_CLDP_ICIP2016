%% riu2 CLBP_S/M joint with NNC

function [accuracyCLBP, elapsedtime]=test_clbp_smcjoint_outex(p,r)
...
for i = 1:train_num
    ...
    clbp_trains(i,:) = clbp_smcjoint(img,r,p,mapping,'h');
...
for i = 1:test_num
    ...
    clbp_tests(i,:) = clbp_smcjoint(img,r,p,mapping,'h');
